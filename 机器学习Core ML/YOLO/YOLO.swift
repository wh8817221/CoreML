...
class YOLO {
    ...
    let model = _416_1()
    public func computeBoundingBoxes(features: _416_1Output) -> [Prediction] {
...
//        let features: MLMultiArray = features[0]
        ...
        for cy in 0..<gridHeight {
            for cx in 0..<gridWidth {
                for b in 0..<boxesPerCell {
                    ...
                    let tc = Float(featurePointer[offset(channel + 4, cx, cy)]) //label
